# 👾 Hello, World! I'm Trần Quốc Tuấn

> *"Turning coffee and crazy ideas into playable realities. Solo Game Developer by day, gamer by night."*

---

## 🎮 About Me
- 🎯 **Focus:** Solo Game Development (Full-stack), Core Gameplay & System Architecture.
- 🚀 **Philosophy:** Fun gameplay first, clean code second, and always keeping the frame rate high.
- 💡 **Currently working on:** ⚔️ **Shisui** - A solo-developed pixel art tower defense game featuring Uchiha Shisui. Built using Unity and C#, handling everything from core mechanics, upgradeable skills, AI, to UI/UX.
- 🌱 **Mastering:** C# advanced patterns, Unity Engine optimization, and surviving as a solo developer!
